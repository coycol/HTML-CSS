...
--\
-- Host: localhost:8889\
-- Generation Time: Sep 10, 2018 at 12:28 AM\
...
(1, 'WE ARE THE RELEVANCE AGENCY', 'We\'92re relevance obsessed. More importantly, we\'92re relevance equipped.', 'go-all-in.gif', 'We are an integrated agency with PR, Digital and Content at our core. Our ambition is to create change through brave, relevant work worthy of awe, action and awards. By embracing new technologies and pushing creative boundaries, we help our clients adapt and win in a constantly evolving world.<br>We are committed to delivering the deepest insights, boldest ideas and broadest engagement to the world\'92s leading brands through seamless integrated communications.<br>We\'92re the nice guys who kick ass.');\
\
-- --------------------------------------------------------\
\
--\
